...
from users.services import convert_rub_to_usd, create_stripe_price, create_stripe_sessions, create_stripe_product
...
class PaymentCreateAPIView(generics.CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        price = create_stripe_price(amount_in_usd, product_id)
